...
<ul class="nml__editor__content__bullet__list">
   <li class="nml__editor__content__listItem">
      <p>Implements <a target="_blank" rel="noopener noreferrer nofollow" class="nml__editor__content__link" href="https://ahikmah.com">This is an external link</a></p>
   </li>
   <li class="nml__editor__content__listItem">
...
export const _posts = () =>
  [...Array(19)].map((_, index) => {
    ...
    return {
      ...
      metaDescription: 'The starting point for your next project with Tikrar Journal Kit',
